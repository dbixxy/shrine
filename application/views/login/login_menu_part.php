    ...
    <nav class="navbar navbar-expand-md menu_head">
        <div class="container p-md-0">
            <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/images/menu_logo.png" alt="menu_logo" class="img-fluid"></a>
            ...
            <div class="collapse navbar-collapse main_menu" id="navbarNav">
                <ul class="navbar-nav m-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url(); ?>Home">หน้าหลัก</a>
                    </li>
                    <li class="nav-item">
